    ...
    <nav class="max-w-7xl mx-auto bg-white/80 backdrop-blur-xl border border-white/20 shadow-2xl rounded-3xl px-6 py-3 flex justify-between items-center transition-all duration-300 relative">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="flex items-center bg-gray-100/50 p-1 rounded-2xl border border-gray-200/50">
                    ...
                    <?php if ($_SESSION['user_role'] !== 'Admin'): ?>
                        <a href="<?php echo $base_url ?? ''; ?>views/feed.php?page=accomplishments" class="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-gray-600 hover:text-gray-900 hover:bg-white hover:shadow-sm transition-all <?php echo (isset($_GET['page']) && $_GET['page'] === 'accomplishments') ? 'bg-white text-gray-900 shadow-sm' : ''; ?>">
        ...
        <div id="mobile-menu-drawer" class="hidden absolute top-20 left-0 right-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 shadow-2xl rounded-2xl p-6 flex-col space-y-4 z-[99] transition-all duration-300">
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <?php if ($_SESSION['user_role'] !== 'Admin'): ?>
                    <a href="<?php echo $base_url ?? ''; ?>views/feed.php?page=accomplishments" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition">
