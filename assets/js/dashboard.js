  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    cell.innerHTML = `
            <div class="day-cell-inner">
              ...
              ${absencesData[fullDate] ? `<div class="absence-badge ${absencesData[fullDate].status.toLowerCase()}">${absencesData[fullDate].status === 'Approved' ? 'Absent' : absencesData[fullDate].status}</div>` : ""}
